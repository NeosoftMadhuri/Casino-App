...
export default function GameHistoryTable() {
  ...
  return (
    <div className={classes.root}>
      ...
      <Grid item sx={12}>
       <Typography align="center"className={classes.tableHeading}>Gaming Histry</Typography> 
        </Grid>
            ...
            <TableBody>
              ...
              {emptyRows > 0 && (
                <Paper className={classes.paper1}>
                   <Typography variant='h5' className={classes.info} align="center">Login or start as a guest...</Typography>
                </Paper>
              )}
            </TableBody>
          </Table>
